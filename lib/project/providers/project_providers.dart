...
final projectProvider = StateNotifierProvider<ProjectNotifier, MusaProject?>((ref) {
...
final currentChapterProvider = Provider<Chapter?>((ref) {
  ...
  return project.chapters.firstWhere((c) => c.id == chapterId, orElse: () => project.chapters.first);
});
